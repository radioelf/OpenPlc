...
class ModbusSerial : public Modbus {
    private:
        ...
        int   _txPin;
        int   _DataLedPin;
        unsigned int _t15;          // tiempo de espera entre caracteres
        unsigned int _t35;          // espera entre tramas
        byte  _slaveId;
    ...
    public:
        ...
        bool config(HardwareSerial* port, long baudn, int txPin, int DataLedPin);

};

/* Tabla de valores CRC para byte alto */
...
/* Tabla de valores CRC para byte bajo */
