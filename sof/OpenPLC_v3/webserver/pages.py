            ...
            <div class='login-page'>
              <div class='form'>
                <form action='login' method='POST' class='login-form'>
                    <h3 style=\"font-family:'Roboto', sans-serif; font-size:24px; color:#1F1F1F; padding:0px 0px 0px 0px; margin: 0px 0px 40px 0px\"><center><b>Bienvenido a OpenPLC</b></center></h3>"""

login_body = """
                    <h3 style=\"font-family:'Roboto', sans-serif; font-size:14px; color:#1F1F1F; padding:0px 0px 0px 0px; margin: 0px 0px 40px 0px\"><center>Use  sus credenciales para iniciar sesion</center></h3>
...
dashboard_tail = """
                    <br>
                    <br>
                    <h2>Logs en tiempo de ejecucion</h2>
                    <textarea wrap='off' spellcheck='false' id='mytextarea'>
loading logs...
                    </textarea>
                    <div class='tooltip' style='margin: 5px 0px 0px 0px'>
                        <button class='button' style='height:45px; padding-top:10px' onclick='copyClipboard()' onmouseout='outFunc()'><span class='tooltiptext' id='myTooltip'>Copiar al portapapeles</span>Copiar logs</button>
                    </div>
    ...
    <script>
        ...
        {
            var tooltip = document.getElementById('myTooltip');
            tooltip.innerHTML = 'Copiar en portapapeles';
        }
...
add_slave_devices_tail = """
                    ...
                    <div style="float:right; width:45%; height:730px">
                        <p style='font-size:20px; margin-top:0px'><b>[04] Input Registers (%IW100) Code:0x02)</b></p>
                        ...
                        <p style='font-size:20px'><b>Coils (%QX100.0 Code:0x0F)</b></p>
                        ...
                        <p style='font-size:20px'><b>Input Registers (%IW100 Code:0x04)</b></p>
                        ...
                        <p style='font-size:20px'><b>Holding Registers - Read (%IW100 Code:0x03)</b></p>
                        ...
                        <p style='font-size:20px'><b>Holding Registers - Write (%QW100 Code:0x10)</b></p>
    ...
    <script type="text/javascript">
        ...
        function validateForm()
        {
            ...
            if (devname == "" || devid == "" || distart == "" || disize == "" || dostart == "" || dosize == "" || aistart == "" || aisize == "" || aorstart == "" || aorsize == "" || aowstart == "" || aowsize == "")
            {
				...
				if (aowsize == "")
					alert("12")
                alert("RTU-Complete todos los campos antes de guardar!");
                alert
                return false;
            }
...
edit_slave_devices_tail = """
                    ...
                    <div style="float:right; width:45%; height:730px">
                        <p style='font-size:20px; margin-top:0px'><b>Discrete Inputs (%IX100.0 Code:0x02)</b></p>
                        <label for='di_start'><b>Start Address:</b></label>
                        <input type='text' style='width: 20%' id='di_start' name='di_start' placeholder='0'>
                        <label for='di_size' style='padding-left:20px'><b>Size:</b></label>
                        <input type='text' style='width: 20%' id='di_size' name='di_size' placeholder='8'>
